...
class SimTimingView():
    ...
    def load(self,main_ui_object,raw_data_load,workload_instance,logic_event_tracker):
        scale = 1
        rsp_or_req = 'CMD'
        ...
        self.cmdtiming_plot.set_summary_box(self.summary_text_box)
        try:
            self.cmdtiming_plot.set_event_tracer_item(logic_event_tracker)
        except:
            None
